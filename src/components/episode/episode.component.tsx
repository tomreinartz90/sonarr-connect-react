        ...
        <div className="row expanded">
          <div className="small-10 columns episode-info">
            ...
            <div className="episode-info">
              {!episode.hasFile ? <span className="label secondary">Missing</span> : <span className="label success">Downloaded</span>}
              &nbsp;<span className="date">{this.isAirdateBeforeNow() ? 'Aired' : 'Airs'} {episode.airDateUtc.toLocaleDateString()}</span>            </div>
          </div>
